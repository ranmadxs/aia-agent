...
ENV OPENROUTER_MODEL="openrouter/inclusionai/ling-3.0-flash-fin:free"
ENV BROWSER=none
EXPOSE 4000
...
RUN mkdir -p /root/.config/opencode /home/opencode/.config/opencode && echo '{"model":"openrouter/inclusionai/ling-3.0-flash-fin:free"}' > /root/.config/opencode/config.json && echo '{"model":"openrouter/inclusionai/ling-3.0-flash-fin:free"}' > /home/opencode/.config/opencode/config.json && chown -R opencode:opencode /home/opencode/.config/opencode
