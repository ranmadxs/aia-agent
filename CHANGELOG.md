...
- `Dockerfile`: Simplificado - `pyproject.toml` cambiado a `>=3.11`, se usa `python3` con `--break-system-packages` sin instalar Python 3.12
...
- `pyproject.toml`: Cambiado `python = "^3.12"` a `python = ">=3.11"` para compatibilidad con la imagen base
